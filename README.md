...
| 이름 | 역할 |  | 깃허브 |
| --- | --- | --- | --- |
| 김도희 | 일정 관리자 & 디자인 | 일정 등록 및 작업보드 관리, 리마인드 | [Github](https://github.com/hee1231) |
| 김보람 | 깃허브 관리자 | PR, 이슈, 프로젝트 등 전반적인 깃허브 태스크와 리드미 관리 | [Github](https://github.com/boram2445) |
| 여다희 | 워크스페이스 관리자 & 스크럼 진행 | 노션 템플릿 자동화, 매일 오전 데일리 스크럼을 진행 | [Github](https://github.com/yeodahui) |
| 이혜원 | 문서 관리자 | 회의록, 컨벤션 등 팀내 문서화 담당 | [Github](https://github.com/donkeeman) |
